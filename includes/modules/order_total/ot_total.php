...
class ot_total {
	...
	function process() {
		...
		$this->output[] = array('title' => $this->title . ':',
                              'text' => '<strong>' . $currencies->format($order->info['total'], true, $order->info['currency'], $order->info['currency_value']) . '</strong> + <a target="_blank" href="' . tep_href_link(FILENAME_SHIPPING) . '">' . MODULE_ORDER_TOTAL_TOTAL_SHIPPING_NOTE . '</a> ',
