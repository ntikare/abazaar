...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Shop order email address', 'SHOP_ORDER_EMAIL_ADRESS', 'root@localhost', 'Shop order email address', '1', '22', now());
