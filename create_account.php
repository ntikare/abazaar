...
// build the message content
      ...
      tep_mail($name, $email_address, EMAIL_SUBJECT, $email_text, STORE_NAME, STORE_REGISTER_EMAIL_ADDRESS);
      tep_mail(STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS, EMAIL_SUBJECT, $email_text, STORE_NAME, STORE_REGISTER_EMAIL_ADDRESS);
